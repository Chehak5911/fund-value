...
import './fnInput-styles.scss'
import { INPUT_LABELS, InputAdornmentPosition, InputIconPosition, InputPresets, InputSizes, InputType, NO_SPACE_REGEX, ONLY_NUMBER_REGEX, VariantTypes } from '../../constants';
import FNCustomTooltip from '../custom-tooltip/FNCustomTooltip';
import { ErrorIcon } from '../../assets';
import { translate } from '../../locales';

interface IFNInputProps {
...
const FNInput = (props: IFNInputProps) => {
  const {
    containerClass = '',
      ...
      {!!label && (
        <div className={`fmvInput__labelContainer ${containerClass}`}>
          ...
          {isError && !isErrorBorder && (
            <FNCustomTooltip isError message={errorMessage}>
...
export default React.memo(FNInput);
